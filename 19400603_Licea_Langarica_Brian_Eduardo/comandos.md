...
#  git remote add
##   descripcion
El comando git remote add crea una conexión entre tu repositorio Git local y el repositorio Git remoto, permitiéndote introducir
...
#  git rebase
##   descripcion
git rebase es otra forma de integrar cambios entre ramas, pero funciona de forma distinta a git merge. Fusionar conserva el historial completo tanto de la rama principal como de la rama de características.
##   ejemplo
git rebase main
...
#  git diff
##   descripcion
muestra las diferencias entre varios estados de tu repositorio, ya sea comparando tu directorio actual con el área de preparación, el área de preparación con la última confirmación
##   ejemplo
git diff

#  git stash
##   descripcion
Supongamos que quieres moverte a un estado anterior pero no quieres comprometer tu progreso actual
##   ejemplo
git stash
